...
class RockyPaperScissor extends Component {
  state = {
    showResult: false,
    myChoice: {},
    opponentChoice: {},
  ...
  onClickPlayButton = () => this.setState({showResult: false})
  ...
  onGetResult = () => {
    ...
    return (
      <GameResult
        ...
        playAgain={this.onClickPlayButton}
      />
    )
  }
...
export default RockyPaperScissor
